...
- **Technique**:
  ...
  - Webhook: Establish the connection between the LINE server and Google Sheets.
   ...
   ###### _View the demo GIF below or click [here](https://drive.google.com/file/d/1bLeVHpjQG409wCUPCbt3ISDeZqTi2UtF/view?usp=sharing) to watch the video on google drive._  
...
# Ending
#### 🎉 Congratulations on reaching the end of my portfolio !
